    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('BUS', 'Bussines'), ('CUS', 'Customer')], default='CUS', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='booking.room', unique_for_date='date')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
